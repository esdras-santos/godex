...
class _SwapFormState extends State<SwapForm> {
  ...
  String coin1name = "MATIC";
  String coin2name = "GOD";
  String type = "MATIC_to_token";
  String amount = "0.0";
  ...
  List<String> cryptoList = ["GOD", "MATIC"];
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (value) async {
                                    var ethpool = await provider!
                                        .getBalance(exchange1addr);
                                    setState(() {
                                      token1Amount = value;

                                      if (type == "token_to_token") {
                                        token2Amount =
                                            "${amm(int.parse(value), ethpool.toInt(), int.parse(token1Pool))}";
                                      } else if (type == "token_to_MATIC") {
                                        token2Amount =
                                            "${amm(int.parse(value), int.parse(token1Pool), ethpool.toInt())}";
                                      } else if (type == "MATIC_to_token") {
                                        token2Amount =
                                            "${amm(int.parse(value), ethpool.toInt(), int.parse(token1Pool))}";
                                      }
                                      print(token2Amount);
